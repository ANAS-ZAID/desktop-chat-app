...
namespace ChatUser.view.screen
{
    public partial class Chat : Form
    {
        ...
        {
            InitializeComponent();
            searchBox.type=core.classes.TextBoxType.Number;
        ...
        private void AddMessageToChat(Messages message)
        {
            ...
            if (InvokeRequired)
            {
                Invoke(new Action(() => { messagePanel.Controls.Add(box);
        ...
        private void searchBox_TextChanged(object sender, EventArgs e)
        {
            ...
            flowLayoutPanel1.Controls.AddRange(CustomCard.buildList(controller.search(searchBox.Text), controller.onClickChat));
        }
    }
}
