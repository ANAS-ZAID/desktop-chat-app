...
namespace Server.Models
{
    public class Chat : Entity
    {
        ...
        public static Chat fromUser(Users user)
        {
            return new Chat() { chatId = user.phone, chatName = user.name, sentDate = DateTime.Now, userCode=user.userCode,publicType=user.publicType};
        }
